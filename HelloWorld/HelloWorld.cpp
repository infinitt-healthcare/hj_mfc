...
/*
C언어 사용하여 윈도우 프로그램을 작성하는 라이브러리 : Win32 API

MFC -> Win32 API을 클래스화 라이브러리
...
&a; -> void*, int* 
&ch; -> void*, char*
void* : 해당 주소에서부터 원하는 대로 데이터를 형변환해서 읽으세요

typedef void HANDLE;
HINSTANCE; : 응용프로그램 전체 handler
HWND : 윈도우 창 전체 handler
H...

char : ascii code(아스키코드)
_wchar : uni code(유니코드)
